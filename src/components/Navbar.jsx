...
const Navbar = () => {
  ...
  const classButtonBlue =
    "text-white bg-blue-700 hover:bg-blue-80 focus:ring-4 focus:outline-none" +
  ...
  const classButtonRed =
    "text-white bg-red-700 hover:bg-red-80 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2" +
